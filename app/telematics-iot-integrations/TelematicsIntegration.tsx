    ...
    <section className="w-full bg-[#f3f4f6] dark:bg-gray-950 py-12">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-14">
        <div className="grid md:grid-cols-3 gap-6">
          {features.map((item, index) => (
            <div
              key={index}
              className="bg-white dark:bg-gray-900 dark:border dark:border-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition text-center"
            >
              <div className="w-14 h-14 mx-auto mb-4 bg-[#1f6f63] dark:bg-[#154c44] rounded-full flex items-center justify-center">
                <Image
                  src={item.icon}
                  alt={item.title}
                  width={26}
      ...
      <div className="relative bg-[#1f6f63] dark:bg-[#103a35] py-16 px-6 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center text-white">
          ...
          <p className="text-sm md:text-base opacity-90 mb-10 max-w-3xl mx-auto leading-relaxed dark:text-gray-300">
