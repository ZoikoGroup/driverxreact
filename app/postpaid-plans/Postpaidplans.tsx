  ...
  return (
    <>
      ...
      <div className="bg-teal-800 py-8 ">
        <h2 className="text-white text-center font-bold text-3xl  dark:text-white">
...
<div className="w-full py-2">
  <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-2 items-center px-6">
    ...
    <div className="max-w-lg">
      <h3 className="text-2xl font-bold dark:bg-gray-900  dark:text-white text-gray-900 mb-2">
        Coverage, Features & Control
      </h3>

      <p className="text-gray-900  dark:bg-gray-900  dark:text-white font-medium mb-4">
