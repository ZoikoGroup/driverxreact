  ...
  return (
   ...
   <br />
    <section className="w-full bg-[#f5f5f5]">
      ...
      {/* ---------------- HERO ---------------- */}
      <div className="bg-[#1f5f55] py-20 text-center text-white font-semibold text-xl">
      ...
      {/* ---------------- WHO WE SERVE ---------------- */}
      <div className="bg-[#1f5f55] py-14 px-6 text-white text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-10 max-w-6xl mx-auto">
          {serveCards.map((item, i) => (
            <div
              key={i}
              className="bg-white text-gray-800 rounded-lg py-6 px-4 shadow-md font-medium"
            >
              {item}
            </div>
          ))}
      ...
      <div className="max-w-6xl mx-auto px-6 py-14">
        ...
        <div className="overflow-hidden rounded-xl border">
          <div className="grid grid-cols-2 bg-[#1f5f55] text-white font-semibold py-4 px-6">
            <div>Capability</div>
            <div>Outcome</div>
          </div>
          ...
          {capabilities.map((item, i) => (
            ...
            >
              ...
              <div className="text-gray-600">{item.outcome}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-16">
        ...
        <div className="space-y-4 mt-8">
          {steps.map((step, i) => (
            <div
              key={i}
              className="flex items-center gap-4 bg-white rounded-lg p-5 border"
            >
              <div className="w-8 h-8 flex items-center justify-center rounded-full bg-[#1f5f55] text-white font-semibold text-sm">
                {i + 1}
              </div>
