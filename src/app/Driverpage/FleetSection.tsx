      ...
      <section className="bg-gray-100 py-12 border-b">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center items-center gap-10">
            ...
            <Image src="/images/swift.png" alt="Swift" width={100} height={40} />
            <Image src="/images/fedex.png" alt="FedEx" width={100} height={40} />
            <Image src="/images/award.png" alt="Award" width={80} height={60} />
            <Image src="/images/xpo.png" alt="XPO" width={120} height={40} />
          </div>
